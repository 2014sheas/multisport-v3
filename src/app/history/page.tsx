...
export default function HistoryPage() {
  ...
  const [activeTab, setActiveTab] = useState<"summary" | "teams" | "events">(
    "summary"
  );
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Explore the history of our multisport events, including team
          performances, event outcomes, and player statistics from previous
          years.
        </p>
      </div>
